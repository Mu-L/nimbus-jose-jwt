...
public class X509CertUtilsTest extends TestCase {
	...
	public void testParseCertWithECKey()
		...
		String content = IOUtils.readFileToString(new File("src/test/resources/sample-certs/wikipedia.crt"), StandardCharsets.UTF_8);
	...
	public void testParseCertWithRSAKey()
		...
		String content = IOUtils.readFileToString(new File("src/test/resources/sample-certs/ietf.crt"), StandardCharsets.UTF_8);
