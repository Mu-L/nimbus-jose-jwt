...
import com.nimbusds.jose.JOSEIdentifiers;


/**
 * The identifiers to use when creating JWKs.
 *
 ...
 * @version 2021-06-15
 */
public interface JWKIdentifiers {
   ...
   */
  String ENCRYPTION_ALGORITHM = JOSEIdentifiers.ENCRYPTION_ALGORITHM;
   ...
   */
  String X_509_CERT_SHA_1_THUMBPRINT = JOSEIdentifiers.X_509_CERT_SHA_1_THUMBPRINT;
   ...
   *         Parameter</a>
   */
  String X_509_CERT_SHA_256_THUMBPRINT = JOSEIdentifiers.X_509_CERT_SHA_256_THUMBPRINT;
